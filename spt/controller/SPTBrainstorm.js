Ext.define('SPT.controller.SPTBrainstorm', {
    ...
    stores: ['SPTKeywords', 'SPTConcern', 'SPTConcerns', 'SPTConcernComments', 'SPTConcernReply'],
    
    models: ['SPTKeyword', 'SPTConcern', 'SPTConcerns', 'SPTConcernComments', 'SPTConcernReply'],
